...
func NewAirtimeDataProvider(db *sql.DB, redis *redis.Client, hsmInstance hsm.HSMInterface) *AirtimeProvider {
...
func (p *AirtimeProvider) GetPaymentMode() models.PaymentMode {
	return models.PaymentModeAirtime
}

func (p *AirtimeProvider) ValidatePayment(ctx context.Context, req *models.PaymentRequest) error {
...
func (p *AirtimeProvider) validateRequest(req *models.AirtimeDataRequest) error {
	if req.DebitAccount == "" {
...
func (p *AirtimeProvider) ProcessPayment(ctx context.Context, req *models.PaymentRequest) (*models.PaymentResponse, error) {
	return nil, errors.New("use HandlePayment directly for airtime/data requests")
}

func (p *AirtimeProvider) HandlePayment(w http.ResponseWriter, r *http.Request) {
